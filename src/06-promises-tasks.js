...
function willYouMarryMe(isPositiveAnswer) {
  return new Promise((resolve) => {
    const answer = isPositiveAnswer === false ? 'Oh no, she said "No".' : 'Hooray!!! She said "Yes"!';
    if (isPositiveAnswer === true || isPositiveAnswer === false) resolve(answer);
    if (!isPositiveAnswer) throw new Error('Wrong parameter is passed! Ask her again.');
  });
}
